...
class ColorSteeringExp:
    ...
    def __init__(self, config_path="config/config.yaml"):
        ...
        # self.prompts = ["Answer in one word. What is the color of apple?",
        #                 "Answer in one word. What is the color of sea?",
        #                 "Answer in one word. What is the color of ideas?",
        #                 "Answer in one word. What is the color of clear sky?",
        #                 "Answer in one word. What is the color of iphone?",
        #                 "Answer in one word. What is the color of music?",
        #                 "Answer in one word. What is the color of a butterfly?",
        #                 "Answer in one word. What is the color of ripe banana?",
        #                 "Answer in one word. What is the color of fresh snow?"]
    ...
    def _save(self, results, object_prompted):
        out_path = os.path.join(self.output_dir, f"color_of_{object_prompted}_pred_sent.json")
...
if __name__ == "__main__":
    exp = ColorSteeringExp("config/steering_config_pred.yaml")
    exp.run()
